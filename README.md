...
## Description
A Heavily modified ReModCE with a loads of new features and modified to use the OUR API
...
## Installation & Usage
Grab the latest loader from [here](https://github.com/ChisVR/ChisClient/releases/latest/Serpent.Loader.dll) and put it in your Mods directory.
...
In case you want to update you can always grab the latest and even previous versions of Serpent.dll [here](https://github.com/ChisVR/ChisClient/releases/).
